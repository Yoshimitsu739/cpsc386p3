...
var b5y = 300;
var b6x = 1500; //platform 6
var b6y = 300;
var b7x = 1600;//platform 7
var b7y = 150;
var b8x = 1700;//platform 8
var b8y = 200;
var b9x = 2000;//platform 9
var b9y = 170;
var bWidth = 75;
var bHeight = 30;
...
frameRate(60);
	if(stage == 0){
		...
		textSize(28);
		text("Press 'Return' to start", width/2, 250);
		text("Arrows to move", width/2 ,350);
		text("Space bar to jump", width/2 ,400);
		text("X to shoot", width/2 ,300);
